  ...
  return (
    <nav className="sticky top-0 z-[100] border-b border-[var(--border)] bg-[var(--bg)]">
      <div className="container flex min-h-[3.75rem] w-full items-center justify-between gap-3 py-2 sm:min-h-[4rem]">
        ...
        <div
          id="nav-panel"
          className={`fixed left-0 right-0 top-[3.75rem] z-[99] max-h-[calc(100dvh-3.75rem)] h-[calc(100dvh-3.75rem)] border-t border-[var(--border)] bg-[var(--bg)] md:static md:inset-auto md:top-auto md:z-auto md:h-auto md:max-h-none md:flex md:flex-row md:items-center md:gap-1 md:overflow-visible md:border-t-0 md:bg-transparent md:p-0 sm:top-[4rem] sm:max-h-[calc(100dvh-4rem)] sm:h-[calc(100dvh-4rem)] ${
            open ? "flex" : "hidden md:flex"
          }`}
        >
          <div className="flex h-full min-h-0 w-full min-w-0 flex-col justify-between overflow-y-auto px-[clamp(1rem,4vw,2rem)] py-[clamp(1.25rem,4vh,2rem)] md:h-auto md:max-h-none md:w-auto md:flex-row md:items-center md:justify-start md:gap-1 md:overflow-visible md:p-0">
            <div className="flex min-h-0 flex-col gap-1 md:flex-row md:items-center md:flex-1 md:min-w-0">
              {NAV_LINKS.map((link) => {
            ...
            {session && (
              <div className="flex shrink-0 flex-col gap-3 border-t border-[var(--border)] pt-4 md:hidden">
            ...
            {!session ? (
              <>
                <div className="flex w-full shrink-0 flex-col gap-3 border-t border-[var(--border)] pt-4 md:hidden">
                  <Link
                    href="/join"
